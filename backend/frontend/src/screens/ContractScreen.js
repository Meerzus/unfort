        ...
        <motion.div>
            <Container>
                ...
                >
                    ...
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>1.1. Продавец – ИП Милькович Илья
                        Михайлович, ОГРНИП 322861700084485;</motion.h5>
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>1.2. Публичная оферта – публичное
                    ...
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>1.3. Покупатель – физическое лицо,
                    ...
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>1.4. Товар – изделия российского
                        производства, предлагаемые к продаже на сайте https://нашсайт/;</motion.h5>
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>1.5. Интернет-магазин – сайт в сети
                    ...
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>1.6. Заказ – оформленный запрос Покупателя
                    ...
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>1.7. Служба доставки – оператор российской
                    ...
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>2.1. Заказывая Товар на сайте
                        https://нашсайт/ Покупатель выражает свое согласие с вышеизложенными условиями продажи
                        Товара и принимает их.</motion.h5>
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>2.2. Настоящие условия продажи Товара, а
                    ...
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>2.3. Продавец имеет право вносить изменения
                    ...
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>2.4. Нажимая кнопку «Заказать» при
                    ...
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>3.1. Продавец предоставляет возможность
                    ...
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>4.1. Оформление Заказа в Интернет-магазине
                    ...
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>4.2. При регистрации на сайте
                        Интернет-магазина Покупатель обязуется предоставить следующую регистрационную
                        информацию:</motion.h5>
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>4.2.1. фамилия, имя, отчество Покупателя
                    ...
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>4.2.3. адрес электронной почты;</motion.h5>
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>4.2.4. контактный телефон.</motion.h5>
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>4.3. Наименование, количество, ассортимент,
                        цена выбранного Покупателем Товара указываются в корзине Покупателя на сайте
                        Интернет-магазина.</motion.h5>
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>4.4. Продавец не несет ответственности за
                        содержание и достоверность информации, предоставленной Покупателем при оформлении
                        Заказа.</motion.h5>
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>4.5. Покупатель несет ответственность за
                        достоверность предоставленной информации при оформлении Заказа.</motion.h5>
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>4.6. Описания и характеристики Товара в
                        Интернет-магазине содержат основные и достоверные сведения о Товаре.</motion.h5>
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>4.7. По всем возникающим вопросам,
                    ...
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>4.8. Фотографии и макеты Товара,
                    ...
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>4.9. Цена Товара указана на сайте
                        https://нашсайт/ рядом с изображением Товара.</motion.h5>
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>4.10. Получить Товар Покупатель может путем
                        доставки Почты России https://www.pochta.ru/ или СДЭК https://www.cdek.ru/ru.</motion.h5>
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>4.11. Доставка Товара осуществляется по
                    ...
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>4.12. Оплата полной стоимости доставки
                        осуществляется за счет Покупателя.</motion.h5>
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>4.13. Продажа Товара осуществляется путем
                        100% (Сто процентов) предоплаты стоимости Товара.</motion.h5>
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>4.14. Оплата производится путем
                        использования платежной системы на сайте.</motion.h5>
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>4.15. По оформлению заказа Покупателю
                    ...
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>5.1. Цена на Товар, представленный на
                        сайте https://нашсайт/, указана в рублях.</motion.h5>
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>5.2. Цена Товара на сайте https://нашсайт/
                    ...
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>5.3. Продавец вправе предоставлять скидки на
                    ...
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>5.4. Оплата Товара производится Банковской
                        картой при оформлении Заказа на сайте с использованием платежной системы..</motion.h5>
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>5.5. Оплата доставки осуществляется
                    ...
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>6.1. Гарантийный срок на Товара равен 3
                        (Трём) днями исчисляется с момента передачи Товара Покупателю.</motion.h5>
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>6.2. Гарантия распространяется только на
                        ...
                        износа.</motion.h5>
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>6.3. Порядок отмены Заказа:</motion.h5>
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>6.3.1. Для мгновенной отмены Заказа
                    ...
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>6.3.2. Договор купли-продажи считается
                        расторгнутым автоматически, в случае непоступления полной оплаты стоимости Заказа.</motion.h5>
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>6.4. Денежные средства, внесенные
                        ...
                        оплата.</motion.h5>
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>6.5. Товар надлежащего качества, полученный
                    ...
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>7.1. За неисполнение или ненадлежащее
                    ...
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>7.2. Совокупная ответственность Продавца
                    ...
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>8.1. Покупатель обязуется дать свое согласие
                    ...
                    <motion.h5 variants={reveal} className='mx-5 mb-3 p-0'>8.2. Сайт https://нашсайт/ и предоставляемые
                    ...
                    <motion.h4 variants={reveal} className='mx-5 mb-3 p-0'>Все Возникающее споры стороны будут
