        ...
        <motion.div>
            <Container id='info'>
                ...
                >
                    ...
                    <motion.h5 variants={reveal} className='mx-1 mb-3 p-0'>Вы можете вернуть товар, приобретенный в
                    ...
                    <motion.h5 variants={reveal} className='mx-1 my-0 p-0'>Для осуществления возврата предварительно
                    ...
                    <motion.h5 variants={reveal} className='mx-1 mb-3 p-0'><strong>Возврат товара возможно только,
                    ...
                    <motion.h5 variants={reveal} className='mx-1 mb-3 p-0'><strong>Мы рекомендуем возвращать вещи в
                        оригинальной упаковке со всеми защитными этикетками и бирками, которыми был укомплектован
                        ваш товар.</strong></motion.h5>
                    <motion.h5 variants={reveal} className='mx-1 mb-3 p-0'><strong>Если вам не подошел размер, сумма
                    ...
                    <motion.h5 variants={reveal} className='mx-1 mb-3 p-0'><strong>Расходы на доставку товара
                        надлежащего качества в магазин несет покупатель.</strong></motion.h5>
                    <motion.h5 variants={reveal} className='mx-1 mb-3 p-0'>Возмещение денежных средств за товар,
                    ...
                    <motion.h5 variants={reveal} className='mx-1 mb-3 p-0'>Мы вправе отказать покупателю в возврате
                    ...
                    <motion.h5 variants={reveal} className='mx-1 mb-3 p-0'>Покупатель вправе участвовать в проверке
                    ...
                    <motion.h5 variants={reveal} className='mx-1 mb-3 p-0'>Бельевые (нижнее белье, боди, топы, бра),
                    ...
                    <motion.h5 variants={reveal} className='mx-1 mb-3 p-0'>После подтверждения оформления возврата на
                        электронной почте - <strong> «support@unfort.ru»</strong> упакуйте письменное заявление вместе с
                        товаром.</motion.h5>
                    <motion.h5 variants={reveal} className='mx-1 my-0 p-0'>* Пожалуйста, отправляйте товары в
                        оригинальной упаковке, только внутри почтовых коробок, чтобы в дороге оригинальная упаковка
                        не пострадала.</motion.h5>
                    <motion.h5 variants={reveal} className='mx-1 my-0 p-0'>Если товар был дополнительно уложен в
